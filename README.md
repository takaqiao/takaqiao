...
[![Starfinder 2e](https://img.shields.io/badge/Starfinder-2e-1f6feb)](https://paizo.com/starfinder)
[![Babele](https://img.shields.io/badge/Babele-翻译流水线-7b3f99)](https://foundryvtt.com/packages/babele)
...
- 翻译流水线工具（Babele 源文件提取、批量校对、自动翻译）

I'm Taka — a Pathfinder 2e GM running games on Foundry VTT v14. Most of what I publish here is community work for the Chinese-speaking PF2e / SF2e / Crucible VTT scene: translation modules and small quality-of-life add-ons.

---

## 精选项目 / Featured

### Foundry VTT 模组 / Modules

| Module | 简介 / What it does |
|---|---|
| **[pf2e-dsn-persistent-bridge](https://github.com/takaqiao/pf2e-dsn-persistent-bridge)** | 把 Dice So Nice 画布上的持久骰子作为 PF2e 检定 / 伤害 / 重投对话框的输入。<br>Use the dice you physically throw on the canvas (DSN persistent dice) as input for PF2e roll dialogs. |
| **[pf2e-xp-tool](https://github.com/takaqiao/pf2e-xp-tool)** | PF2E XP 预算工具：精英 / 弱小模板预览与多策略补差值方案。<br>Encounter XP planner with elite/weak preview and multi-strategy gap fillers. |
| **[pf2e-character-audit](https://github.com/takaqiao/pf2e-character-audit)** | PF2E 车卡综合审计：出版物来源 / 专长前置条件 / 车卡完整性（boost、语言、专长槽位、技能提升），三合一。<br>One-stop PF2e character audit: publication source, feat prerequisite verification, build completeness (boosts, languages, feat slots, skill increases). |

### 中文翻译模组 / Chinese Translation Modules

| Repo | Foundry Package |
|---|---|
| **[pf2e-compendium-extra-cn](https://github.com/takaqiao/pf2e-compendium-extra-cn)** | PF2e 第三方合集中文翻译 (Babele) |
| **[sf2e_cn](https://github.com/takaqiao/sf2e_cn)** | [`sf2cn`](https://foundryvtt.com/packages/sf2cn) — Starfinder 2e 系统主体中文 |
| **[sf2e_compendium_cn](https://github.com/takaqiao/sf2e_compendium_cn)** | [`sf2ecompendium`](https://foundryvtt.com/packages/sf2ecompendium) — SF2e 合集中文 |
| **[crucible-cn](https://github.com/takaqiao/crucible-cn)** | [`crucible-cn`](https://foundryvtt.com/packages/crucible-cn) — Crucible 系统中文 |
| **[ember_cn_unofficial](https://github.com/takaqiao/ember_cn_unofficial)** | Ember 系统中文（非官方） |
| **[pathbuilder2eTranslation](https://github.com/takaqiao/pathbuilder2eTranslation)** | Pathbuilder 2e 中文翻译草稿 |

### 翻译 / 校对工具 / Translation Tooling

| Repo | 用途 / Use |
|---|---|
| **[compendium-extractor](https://github.com/takaqiao/compendium-extractor)** | 从 FoundryVTT v13/v14 LevelDB compendium pack 抽取 Babele 2.8 翻译源文件 |
| **[fvttAutoTranslateTool](https://github.com/takaqiao/fvttAutoTranslateTool)** | FVTT 自动翻译流水线 |
...
| **pf2e-character-audit** | [![](https://img.shields.io/github/v/release/takaqiao/pf2e-character-audit?style=flat-square&label=&color=blue)](https://github.com/takaqiao/pf2e-character-audit/releases/latest) | [![](https://img.shields.io/endpoint?url=https%3A%2F%2Ffoundryshields.com%2Fversion%3Furl%3Dhttps%3A%2F%2Fgithub.com%2Ftakaqiao%2Fpf2e-character-audit%2Freleases%2Flatest%2Fdownload%2Fmodule.json&style=flat-square&label=)](https://foundryvtt.com/packages/pf2e-character-audit) | ![](https://img.shields.io/github/downloads/takaqiao/pf2e-character-audit/total?style=flat-square&label=&color=brightgreen) | ![](https://img.shields.io/github/downloads/takaqiao/pf2e-character-audit/latest/total?style=flat-square&label=) |
...
<sub>所有翻译模组均通过 GitHub Actions 自动同步到 Foundry packages registry。<br>Issue / PR 欢迎 — 校对错误、术语建议、兼容性反馈都会处理。</sub>
